  ...
  return (
    <div className="grid max-w-full gap-6 overflow-x-hidden">
      ...
      <section className="grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">
        <div className="min-w-0 rounded-lg bg-white p-5 shadow-sm">
      ...
      {templateEditorOpen && activeTemplate ? (
        <div className="fixed inset-0 z-50 grid place-items-center overflow-x-hidden bg-slate-950/70 p-3 sm:p-4">
          <div className="max-h-[92vh] w-full max-w-4xl min-w-0 overflow-y-auto overflow-x-hidden rounded-lg bg-white shadow-2xl">
            ...
            <div className="grid gap-5 p-5">
              <div className="flex min-w-0 flex-wrap gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-2 rounded bg-slate-100 px-4 py-2 text-sm font-black text-slate-700 sm:ml-auto"
                >
