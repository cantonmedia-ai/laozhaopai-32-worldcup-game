...
set preferred_language = coalesce(preferred_language, 'zh');

update public.profiles
set email_verified = true,
    updated_at = now()
where coalesce(auth_provider, provider, login_provider) = 'google'
...
begin
  ...
  v_provider := coalesce(v_user.app_metadata->>'provider', 'email');
